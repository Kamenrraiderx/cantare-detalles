  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className="lg:px-60 flex gap-3 md:flex-row flex-col">
        <Feature image1="/images/createYourBucket.jpg" image2="" title="Crea tu ramo" icon="square"/>
        <Feature image1="/images/specialDetails.jpg" image2="" title="Detalles especiales" icon="gem"/>
        <Feature image1="/images/aboutMe.jpg" image2="" title="Conoceme" icon="circle"/>
      </div>
